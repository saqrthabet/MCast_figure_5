function gfml=gpafml(htxtt,lumbda_sorted,powertot,block_totnum,hbidx)
...
wg2=0;
     ...
     for chcpa=1:block_totnum                     
         ...
         sigma_sgpa=lumbda_sorted(locblkpa);   % single Chunk variance
    ...
    % the rest of equation 3 in ParCast 
     for chc=1:block_totnum
       ...
       sigma_sg=lumbda_sorted(locblkchc);
