function [PSNRgop,uv,g]=mtime_latgopparfml_joint(filename,SNR_table,fln,gopcnt,skip,tslots_num,blk_num_i,blk_num_j,gopbg,goptmt)
%% parameter setting
SNR_list=SNR_table;
...
H=H;   % The overall channel materix of all subcarriers stacked in one
 %rng('default');            %SAQR
 %s = rng;
 %H = raylrnd(1,block_totnum,tslots_num);
...
%                      end       
                  ...
                  for bb=1:block_totnum
                     ...
                     sigma_scur=lumbda_sorted(bb); % lumbda i
